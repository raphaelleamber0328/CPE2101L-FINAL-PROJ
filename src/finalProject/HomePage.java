...
public class HomePage {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                HomePage window = new HomePage(testUser); 
    ...
    private void initialize(String email) {
        ...
        confirmBtn.addActionListener(e -> {
            ...
            // ================= BOOKING DATA =================
            String destination = (String) toBox.getSelectedItem();
            ...
            if (selectedClass.equalsIgnoreCase("Business")) {
                newBooking = new BusinessBooking(
                        currentUser,
                        destination,
                        flightDetails,
                        travelDate
